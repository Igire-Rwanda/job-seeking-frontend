  ...
  return (
    <div className="flex  divide-x-2 pt-20">
      <div className="p-7 space-y-8">
        ...
        <div className=" rounded-full px-8 py-1">
          <p>Post a job</p>
        </div>
      ...
      <div className="pl-20   font-semibold ">
        ...
        <div className="bg-white ml-20 rounded-md mt-5	max-w-full h-3/4">
          <div className=" px-10 py-3">
            <h4 className="pr-5">Job Description</h4>
          <p>Describe the responsabilities of this job, required work experience, skills, or education </p>
            <h3 className="text-blue-900">Upload a PDF or DOCX</h3>
            <form>
   <div class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-white dark:border-gray-600">
       ...
       <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-white">
           <label for="editor" class="sr-only">Publish post</label>
           <textarea id="editor" rows="8" class="block px-0 w-full text-sm text-gray-800 bg-white border-0 dark:bg-white focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
       </div>
   </div>
          ...
          <a
            href="./JobDetails"
            class="text-blue-900	mb-6 float-left mb-5 bg-white	 border-l-2 focus:border-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  ml-5 mb-2 dark:bg-white dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            Back
          </a>
          ...
          <a
            href="./JobDescription"
            class="text-white mb-6 float-right mr-20 mb-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
Post Job          </a>
        </div>
      </div>
