      ...
      <nav className='shadow-md w-full fixed top-0 left-0 z-index-50'>
        <div className='md:flex bg-white py-2 items-cennter justify-between md:px-20 mt:10'>
          ...
          <ul className='md:flex md:pb-0 pb-1 py-3 absolute md:static bg-white md:z-auto z-[-1] left-0 md:w-auto md:pl-0 pl-5'>
            ...
            <NavLink to='/PostJob'><li className='mx-4 hover:text-teal-500 duration-500 cursor-pointer text-l md:ml-8 md:my-0 my-5 py-3 px-5'>Hire Talent</li></NavLink>
            <NavLink to='/aboutUs'><li className='mx-4 hover:text-teal-500 duration-500 cursor-pointer text-l md:ml-8 md:my-0 my-5 py-3 px-5'>About Us</li></NavLink>
